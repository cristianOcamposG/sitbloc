    ...
    <body >
        ...
        <div class="d-flex">
            <div class="card col-sm-5">
                ...
                <form action="principalCTR?menu=ganados" method="POST">
                    <div class="form-group" >
                        <h4> Nuevo ganado<span class="badge badge-secondary"></span></h4>

                        <label>Codigo del ganado</label>
                        <input type="text" value="${ganado.getGana_cod_ganado()}" name="codgana"  class="form-control">
                        <small class="form-text text-muted">Ingrese el codigo de la caravana</small>


                        <label>Fecha de Nacimiento (YYYY/MM/DD)</label>
                        <input type="date" value="${ganado.getGana_fec_nacimiento()}" name="fecnac"  class="form-control">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-12" >
                                ...
                                <input type="number" value="${ganado.getGana_peso_ganado()}"  name="pesogana" class="form-control">
                            </div>
                    ...
                    <tbody>
                        <c:forEach var="ganado" items="${ganados}">
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-warning" href="principalCTR?menu=ganados&accion=modificar&id_ganado=${ganado.getGana_id_ganado()}" ><i class="fas fa-history"></i></a>

                                    <a class="btn btn-danger" href="principalCTR?menu=ganados&accion=eliminar&id_ganado=${ganado.getGana_id_ganado()}"><i class="fas fa-trash"></i></a> 
